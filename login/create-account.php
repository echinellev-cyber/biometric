<?php
// Start PHP code at the very top
require_once '../connection.php'; // Include your database connection

function superAdminExists($conn) {
    $stmt = $conn->prepare("SELECT COUNT(*) as count FROM admin WHERE role = 'super_admin'");
    $stmt->execute();
...
try {
    $superAdminExists = superAdminExists($conn);
} catch (Exception $e) {
...
<body>
    <div class="registration-container">
        ...
        <p class="subtitle">Create a new administrator account for the system</p>
            ...
            <form id="registerForm" action="register_admin.php" method="POST">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (usernameInput) {
        usernameInput.addEventListener('input', function() {
            ...
            usernameAvailability.className = 'input-hint';
    ...
    // Registration form submission - CORRECTED VERSION
    if (registerForm) {
        registerForm.addEventListener('submit', async function(e) {
            ...
            // Send data via AJAX to register_admin.php
